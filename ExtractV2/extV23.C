...
//fine{{{
		...
		l_1fine->Draw();
		cdphi1_fine->SaveAs(Form("ProjDist/CorrDistdphi/fit_corr1_Mult_%d-%d_pt_%d-%d_rap_%d-%d_Trkpt_%d-%d_neta_%d_nphi_%d_%s_sepa_tra_%d.pdf", (int)multMin, (int)multMax, (int)ptMin, (int)ptMax, (int)(10*rapMin), (int)(10*rapMax), (int)TrkptMin, (int)TrkptMax, Netabin1, Nphibin1, version.Data(), imass));
//}}}
...
//}}}
	...
	TFile* fout = new TFile(Form("ProjDist/DistFiles/v2_dist_Mult_%d-%d_pt_%d-%d_rap_%d-%d_Trkpt_%d-%d_tra_%s.root", (int)multMin, (int)multMax, (int)ptMin, (int)ptMax, (int)(10*rapMin), (int)(10*rapMax), (int)TrkptMin, (int)TrkptMax, version.Data()), "RECREATE");
	fout->cd();
	gv2_1fine->Write();
	gv2_1coarse->Write();
	gv2_1p5fine->Write();
