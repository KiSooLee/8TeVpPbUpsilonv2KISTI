...
//}}}
	...
	FormTH1Marker(hRW0, 0, 1, 1.6);
	FormTH1Marker(hRW1, 1, 0, 1.6);
	...
	hRW0->Draw("pe");
	hRW1->Draw("pesame");
	TLegend* leg1 = new TLegend(0.15, 0.7, 0.5, 0.88);
	...
	hratio->Divide(hratio, hRW0, 1, 1, "B");
	...
	FormLatex(lt2, 12, 0.12);
	lt2->DrawLatex(0.3, 0.8, "Acc.dN/dp_{T} weighted/ Acc. non-weighted");
	SetLine(2, 0, 1, 30, 1, 0, 3);
	c1->SaveAs(Form("Plots/Acc_RWcomp_Upsilon_%dS_MupT%s.pdf", Generation, MupT.Data()));
}
