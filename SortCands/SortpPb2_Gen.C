...
void SortpPb2_Gen(const Int_t multMin = 0, const Int_t multMax = 300, const Double_t ptMin = 0, const Double_t ptMax = 30, const Double_t rapMin = -2.4, const Double_t rapMax = 2.4, const Double_t TrkptMin = 0, const Double_t TrkptMax = 1, const TString MupT = "4")
{
//make directory{{{
...
//}}}
	...
	TFile* fout = new TFile(Form("%d-%d_%d-%d_%d-%d_%d-%d_pPb2_MupT%s/Sort_OniaTree_pPb2_PADoubleMuon_MC_Gen.root", multMin, multMax, (int)ptMin, (int)ptMax, (int)(rapMin*10), (int)(rapMax*10), (int)TrkptMin, (int)TrkptMax, MupT.Data()), "RECREATE");//embedded MC sample
	//TFile* fout = new TFile(Form("%d-%d_%d-%d_%d-%d_%d-%d_pPb2_MupT%s/Sort_OniaTree_pPb2_PADoubleMuon_MC_Gen_nonemb.root", multMin, multMax, (int)ptMin, (int)ptMax, (int)(rapMin*10), (int)(rapMax*10), (int)TrkptMin, (int)TrkptMax, MupT.Data()), "RECREATE");//nen-embedded MC sample
