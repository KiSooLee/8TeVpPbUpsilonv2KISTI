...
void SortpPb2_Reco(const bool isMC = false, const Int_t multMin = 0, const Int_t multMax = 300, const Double_t ptMin = 0, const Double_t ptMax = 30, const Double_t rapMin = -2.4, const Double_t rapMax = 2.4, const Double_t TrkptMin = 0, const Double_t TrkptMax = 1, const TString MupT = "4", const Bool_t isSS = false, const Int_t imass = 0)
{
//make directory{{{
	TString mainDIR = gSystem->ExpandPathName(gSystem->pwd());
	TString saveDIR = mainDIR + Form("/%d-%d_%d-%d_%d-%d_%d-%d_pPb2_MupT%s", multMin, multMax, (int)ptMin, (int)ptMax, (int)(rapMin*10), (int)(rapMax*10), (int)TrkptMin, (int)TrkptMax, MupT.Data());
...
//Get files{{{
	...
	if(isMC)
	{
		...
		//fname1 = "root://cms-xrdr.private.lo:2094///xrd/store/user/kilee/pPb_8TeV_OniaTrkTree/oniaTree_pPb2_MC_1S_private_20200716.root";//private embedded
		fname1 = "root://cms-xrdr.private.lo:2094///xrd/store/user/kilee/pPb_8TeV_OniaTrkTree/oniaTree_pPb2_MC_1S_official_20201109.root";//official embedded
		//fname1 = "root://cms-xrdr.private.lo:2094///xrd/store/user/kilee/pPb_8TeV_OniaTrkTree/oniaTree_pPb2_MC_1S_non-embed.root";//official non-embedded
	}
	else
	{
...
//}}}
	...
	TFile* fout = new TFile(Form("%d-%d_%d-%d_%d-%d_%d-%d_pPb2_MupT%s/Sort_OniaTree_pPb2_PADoubleMuon_%s_%s_%d.root", multMin, multMax, (int)ptMin, (int)ptMax, (int)(rapMin*10), (int)(rapMax*10), (int)TrkptMin, (int)TrkptMax, MupT.Data(), MorD.Data(), SS.Data(), imass), "RECREATE");
	//TFile* fout = new TFile(Form("%d-%d_%d-%d_%d-%d_%d-%d_pPb2_MupT%s/Sort_OniaTree_pPb2_PADoubleMuon_%s_%d.root", multMin, multMax, (int)ptMin, (int)ptMax, (int)(rapMin*10), (int)(rapMax*10), (int)TrkptMin, (int)TrkptMax, MupT.Data(), MorD.Data(), imass), "RECREATE");
	//TFile* fout = new TFile(Form("%d-%d_%d-%d_%d-%d_%d-%d_pPb2_MupT%s/Sort_OniaTree_pPb2_PADoubleMuon_%s_nonemb_%d.root", multMin, multMax, (int)ptMin, (int)ptMax, (int)(rapMin*10), (int)(rapMax*10), (int)TrkptMin, (int)TrkptMax, MupT.Data(), MorD.Data(), imass), "RECREATE");//nen-embedded MC sample
