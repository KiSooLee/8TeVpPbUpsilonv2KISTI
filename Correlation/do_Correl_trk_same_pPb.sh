...
root -l -b -q 'Correl_trk_Reco_same_pPb.C+(false, 110, 300, 10, 30, -2.4, 2.4, 0, 3, "v17", "4", '$1')'
#root -l -b -q 'Correl_trk_Gen_same_pPb.C+(0, 40, 10, 30, -2.4, 2.4, 0, 3, "v17", "4", '$1')'
#for((i=0; i<18; i++))
#do
#	root -l -b -q 'Correl_trk_Reco_same_pPb.C+(false, 0, 40, 10, 30, -2.4, 2.4, 0, 3, "v17", "4", '$i')'
#done
#for((i=0; i<18; i++))
#do
