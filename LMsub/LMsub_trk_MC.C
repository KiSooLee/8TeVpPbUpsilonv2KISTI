...
//}}}
	...
	for(Int_t imult = 0; imult < 2; imult++)
	{
		for(Int_t ipt = 0; ipt < pt_narr-1; ipt++)
		{
			...
			TH1D* htemp = (TH1D*) fv2[imult][ipt]->Get(Form("hRef_%s_%s", Away.Data(), Fine.Data()));
