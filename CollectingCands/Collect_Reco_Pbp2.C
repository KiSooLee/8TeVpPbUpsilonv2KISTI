...
void Collect_Reco_Pbp2(const bool isMC = false, const Int_t multMin = 0, const Int_t multMax = 300, const Double_t ptMin = 0, const Double_t ptMax = 30, const Double_t rapMin = -2.4, const Double_t rapMax = 2.4, const Double_t TrkptMin = 0, const Double_t TrkptMax = 1, const TString MupT = "4", const TString trkptversion = "v1", const Bool_t isSS = false, const Int_t imass = 0)
{
//make directory{{{
...
//Get files{{{
	TString fname1;
	fname1 = Form("root://cms-xrdr.private.lo:2094///xrd/store/user/kilee/pPb_8TeV_OniaTrkTree/resultPbp2/total_MupT%s/Sort_OniaTree_Pbp2_PADoubleMuon_%s_%s_%d.root", MupT.Data(), MorD.Data(), SS.Data(), imass);
	//fname1 = Form("root://cms-xrdr.private.lo:2094///xrd/store/user/kilee/pPb_8TeV_OniaTrkTree/resultPbp2/total_MupT%s/Sort_OniaTree_Pbp2_PADoubleMuon_%s_%d_nonemb.root", MupT.Data(), MorD.Data(), imass);//non-embedded MC sample
	//fname1 = Form("0-1500_0-30_-24-24_0-10_Pbp2/Sort_OniaTree_Pbp2_PADoubleMuon_%s_%d.root", MorD.Data(), imass);
