...
void Collect_Gen_Pbp2(const Int_t multMin = 0, const Int_t multMax = 300, const Double_t ptMin = 0, const Double_t ptMax = 30, const Double_t rapMin = -2.4, const Double_t rapMax = 2.4, const Double_t TrkptMin = 0, const Double_t TrkptMax = 1, const TString MupT = "4", const TString trkptversion = "v1", const Int_t imass = 0)
{
//make directory{{{
...
//Get files{{{
	TString fname1;
	fname1 = Form("root://cms-xrdr.private.lo:2094///xrd/store/user/kilee/pPb_8TeV_OniaTrkTree/resultPbp2/total_MupT%s/Sort_OniaTree_Pbp2_PADoubleMuon_MC_%d.root", MupT.Data(), imass);
...
//store{{{
	TFile* fout = new TFile(Form("%d-%d_%d-%d_%d-%d_%d-%d_Pbp2_MupT%s_trk%s/Sort_OniaTree_Gen_Pbp2_PADoubleMuon_MC_%d.root", multMin, multMax, (int)ptMin, (int)ptMax, (int)(rapMin*10), (int)(rapMax*10), (int)TrkptMin, (int)TrkptMax, MupT.Data(), trkptversion.Data(), imass), "RECREATE");
	fout->cd();
	tout->Write();
	fout->Close();
//}}}
